...
public class ProductBean {
	...
	public ProductBean(int product_number, String product_name, String image, Integer price, String content,
			Integer temperature, int s_stock, int m_stock, int l_stock, int xl_stock, String smallcategory_name,
			MultipartFile pImage, MultipartFile pContent) {
		super();
